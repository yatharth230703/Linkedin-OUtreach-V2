...
## Scrape connections, tally against Supabase entries, send first messages
...
def scrape_all_connections_brute(page):
    """
...
def main():
    ...
    try:
        ...
        connections_dict, leads_to_message = scrape_all_connections_brute(page)
